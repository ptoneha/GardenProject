...
@RestController
@RequestMapping("/portal/agri/task")
...
public class PortalTaskController extends BaseController
{
    ...
    @Log(title = "门户规划任务", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "门户规划任务", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "门户规划任务", businessType = BusinessType.DELETE)
